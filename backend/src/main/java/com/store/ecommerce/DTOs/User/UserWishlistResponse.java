...
import com.store.ecommerce.DTOs.Wishlist.WishlistWithoutUserResponse;
...
public class UserWishlistResponse {
    ...
    private List<WishlistWithoutUserResponse> wishList = new ArrayList<>();
    ...
    public UserWishlistResponse(CustomUser _CustomUser){
        ...
        this.wishList = _CustomUser.getWishList().stream()
                            .map(WishlistWithoutUserResponse::new).collect(Collectors.toList());
    } 
}
